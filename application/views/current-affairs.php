                ...
                <div class="parallax pageContent">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        <div class="container">
                            ...
                            <i class="fa fa-long-arrow-right main-color"></i><span>Current Affairs</span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <article class="post-content">
                                            ...
                                            <a href="<?php echo base_url('resources/current-affair/' . $currentaffair->url_slug); ?>">
                                                <?php 
                                                    if($currentaffair->ca_image){ ?>
                                                                   ...
                                                                   <?php }else{ ?>
                                                                        <img src ="<?php echo base_url()?>/assets/uploads/ca_icon.jpg" height="150" width="150"/>
                                                                  <?php  }
                                        ...
                                        <div class="post-item-rit">
                                            <div class="post-info-container">
                                                <div class="post-info">
                                                    <h4><a href="<?php echo base_url('resources/current-affair/' . $currentaffair->url_slug); ?>"><?php echo $currentaffair->ca_title; ?></a></h4>
                                                    <ul class="post-meta">
                                                        <li class="main-bg"><i class="fa fa-book"></i></li>
                                                        <li class="meta-user"><i class="fa fa-user"></i>By: <b>Vibrant Career</b></li>
                                                        <li class="meta_date"><i class="fa fa-clock-o"></i><b><?php $date = $currentaffair->ca_date;
                                            ...
                                            <p><?php echo $description; ?> <a class="more_btn main-color" href="<?php echo base_url('resources/current-affair/' . $currentaffair->url_slug); ?>">Read More</a></p>
                                        </div>
                                    </article>
                                </div>
