            ...
            <div class="pageContent">
                <div class="parallax pageContent">
                    <div class="page-title" id="pageTitle">
                        <div class="container">
                            <div class="col-md-12">
                                <h1 class="uppercase bolder"><?php echo $currentaffair['ca_title']; ?></h1>
                            </div>
                        </div>
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        <div class="container">
                            ...
                            <a href="<?php echo base_url() ?>resources/current-affairs">Current Affairs</a>
                            <i class="fa fa-long-arrow-right main-color"></i>
                            <span> 
                                <?php
                                   $title = word_limiter($currentaffair['ca_title'], 5, '&#8230;');
                                   echo $title;
                                ?>
                            </span>
                        </div>
                                    ...
                                    <div class="post-item">
                                        ...
                                        <div class="details-img">
                                             <?php if ($currentaffair['ca_image']) { ?>
                                               <img height="437" width="100%" src="<?php echo base_url() . substr($currentaffair['ca_image'], 2); ?>" alt="">
                                            <?php } ?>
                                            ...
                                            <div class="widget-content">
                                                <ul id ="show_data">
                                                    ...
                                                    if (!empty($currentaffairs)): foreach ($currentaffairs as $currentaffair):
                                                            ...
                                                            <li>
                                                                <div class="post-img">
                                                                    <a href="<?php echo base_url('resources/current-affair/' . $currentaffair['url_slug']); ?>">
                                                                       
                                                                                <?php if ($currentaffair['ca_image']) { ?>
                                                                                    <img src ="<?php echo base_url() . substr($currentaffair['ca_image'], 2); ?>" height="50" width="50"/>
                                                                                <?php } else { ?>
                                                                                    <img src ="<?php echo base_url() ?>/assets/uploads/ca_icon.jpg" height="50" width="50"/>
                                                                                <?php }
                                                                                ?>
                                                                       </a>
                                                                </div>
                                                                <div class="widget-post-info">
                                                                    <h5><a class="blog-list-head" href="<?php echo base_url('resources/current-affair/' . $currentaffair['url_slug']); ?>"><?php
                                                                            $title = word_limiter($currentaffair['ca_title'], 3, '&#8230;');
                                                                            echo $title;
                                                                            ?></a>
                                                                    </h5>
                                                                    <div class="meta">
