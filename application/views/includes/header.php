        ...
        <div class="responsive-nav">
            ...
            <nav class="top-nav" id="topNav">
                <ul>
                    <li class="
                    <?php
                    if ($this->uri->uri_string() == '' || $this->uri->uri_string() == 'best-bank-coaching-in-bhopal') {
                        echo 'selected';
                    }
                    ?>">
                        <a href="
<?php echo base_url() ?>best-bank-coaching-in-bhopal">
                    ...
                    <li class="
                        <?php
                        if ($this->uri->uri_string() == 'about-us') {
                            echo 'selected';
                        }
                        ?>">
                        <a href="
<?php echo base_url() ?>about-us">
                    ...
                    if ($this->uri->uri_string() == 'courses-offered' ||
                            ...
                            $this->uri->uri_string() == 'courses/mppeb' ||
...
<?php echo base_url() ?>courses/insurance-entrance-exams">
                                                    ...
                                                    <li>
                                                        <a href="
<?php echo base_url() ?>courses/mppeb">
                                                            <i class="fa fa-book"></i>MPPEB (VYAPAM)
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
...
<?php echo base_url() ?>courses/spoken-english-classes-for-all">
                    ...
                    if ($this->uri->uri_string() == 'resources' ||
                            ...
                            $this->uri->uri_string() == 'resources/questions' ||
                            $this->uri->uri_string() == 'resources/blogs' ||
                            $this->uri->uri_string() == 'resources/videos' ||
...
<?php echo base_url() ?>resources/vocabulary">
                            ...
                            <li style="transition-delay: 100ms;">
                                <a href="
<?php echo base_url() ?>resources/questions">
                                    <i class="fa fa-book"></i>Question of the day
                                </a>
                            </li>
                            <li style="transition-delay: 150ms;">
                                <a href="
<?php echo base_url() ?>resources/blogs">
                                    <i class="fa fa-book"></i>Blogs
                                </a>
                            </li>
                            <li style="transition-delay: 170ms;">
                                <a href="
<?php echo base_url() ?>resources/videos">
