                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <?php
                                $attributes = array('name' => 'Edit-qestion', 'role' => 'form', 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8');
                                echo form_open('Question_of_the_day/editQuestion/' . $question->question_id, $attributes);
                                ?>
                                  <div class="box-body">
                                    
                                    <div class="form-group">
                                        <label for="description">Question</label>
                                        <?php echo form_textarea(['class' => 'form-control', 'rows' => '10', 'name' => 'description', 'id' => 'editor1', 'type' => 'text', 'placeholder' => 'Enter description', 'value' => set_value('description', $question->description)]); ?>
                                    </div>
                                    <div class="validation-msg"><?php echo form_error('description') ?></div>
                                    <div class="form-group">
                                        <label for="explanation">Explanation</label>
                                        <?php echo form_textarea(['class' => 'form-control', 'rows' => '10', 'name' => 'explanation', 'id' => 'editor2', 'type' => 'text', 'placeholder' => 'Enter explanation', 'value' => set_value('explanation',$question->explanation)]); ?>
                                    </div>
                                    
                                    <div class="validation-msg"><?php echo form_error('explanation') ?></div>
                                    <div class="form-group">
                                        <label for="answer">Answer</label>
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'answer', 'id' => 'answer', 'type' => 'text', 'placeholder' => 'Enter Answer', 'value' => set_value('answer', $question->answer)]); ?>
                                    ...
                                    <div class="form-group">
                                        <?php 
                                            if($question->image){ ?>
                                                <img style ="border:1px solid grey"src ="<?php echo base_url().substr($question->image, 2); ?>" height="100" width="100"/> 
                                           <?php } else { ?>
                                                <img src ="<?php echo base_url()?>/assets/uploads/no-image.png" height="100" width="100"/>
                                          <?php    }
                                        
                                        ?>
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'old-question-image', 'id' => 'old-blog-image', 'type' => 'hidden', 'value' => set_value('old-blog-image', $question->image)]); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'author', 'id' => 'author', 'type' => 'text', 'placeholder' => 'Enter author name', 'value' => set_value('author',$question->author)]); ?>
                                    </div>
                                    <div class="validation-msg"><?php echo form_error('author') ?></div>  
                                      <div class="form-group col-xs-12 col-md-2">
                                        <label for="date">Date</label>
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'date', 'id' => 'date', 'type' => 'date', 'placeholder' => '', 'value' => set_value('date', $question->date)]); ?>
                                    </div>
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?php echo base_url('daily-questions') ?>" class="btn btn-danger">Cancel</a>
                                </div>
