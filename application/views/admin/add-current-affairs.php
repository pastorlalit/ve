        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Current Affairs
                        <small>Add current affairs</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url() ?>admin-panel"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?php echo base_url() ?>view-current-affairs"><i class="fa fa-pencil-square-o"></i> Current Affairs</a></li>
                        <li class="active">Add Current Affairs</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <?php
                                    $currentMsg = $this->session->flashdata('currentMsg');
                                    switch ($currentMsg) {
                                        case "success":
                                            echo '<div class="alert alert-success square " data-close="true">
                                                               <p>Record inserted successfully! <i class="fa fa-thumbs-o-up ico-block"></i></p>
                                                              </div>';
                                            break;
                                        case "error":
                                ...
                                <?php
                                $attributes = array('name' => 'add-current-affairs', 'role' => 'form', 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8');
                                echo form_open('CurrentAffairs/InsertCurrentAffairs', $attributes);
                                ?>
                                <div class="box-body">
                                    
                                    <div class="form-group">
                                        <label for="title">Title</label>
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'ca_title', 'id' => 'ca_title', 'type' => 'text', 'placeholder' => 'Enter Title', 'value' => set_value('ca_title')]); ?>

                                    </div>
                                    <div class="validation-msg"><?php echo form_error('ca_title') ?></div>
                                    <div class="form-group">
                                        <label for="description">Description</label>
                                        <?php echo form_textarea(['class' => 'form-control', 'rows' => '5', 'name' => 'ca_description', 'id' => 'editor1', 'type' => 'text', 'placeholder' => 'Enter description', 'value' => set_value('ca_description')]); ?>
                                    </div>
                                    <div class="validation-msg"><?php echo form_error('ca_description') ?></div>
                                    <div class="form-group">
                                        <label for="image">Image</label>
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'ca_image', 'id' => 'ca_image', 'type' => 'file', 'value' => set_value('ca_image')]); ?>
                                    ...
                                    <div class="form-group col-xs-12 col-md-2">
                                        ...
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'ca_date', 'id' => 'ca_date', 'type' => 'date', 'placeholder' => '', 'value' => set_value('ca_date')]); ?>
                                    </div>
