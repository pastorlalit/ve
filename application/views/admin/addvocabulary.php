                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <?php
                                $attributes = array('name' => 'add-vocab', 'id' => 'add-vocab-form', 'role' => 'form', 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8');
                                echo form_open('Vocabulary/InsertVocab', $attributes);
                                ?>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['class' => 'form-control', 'name' => 'word', 'id' => 'word-input', 'type' => 'text', 'placeholder' => 'Enter word', 'value' => set_value('word')]); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['class' => 'form-control', 'name' => 'meaning', 'id' => 'meaning', 'type' => 'text', 'placeholder' => 'Enter word meaning', 'value' => set_value('meaning')]); ?>

                                            </div>
                                            <div class="validation-msg"><?php echo form_error('meaning') ?></div>
                                        </div> 
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="word-title">Description</label>
                                                <?php echo form_input(['class' => 'form-control', 'name' => 'description', 'id' => 'description', 'type' => 'text', 'placeholder' => 'Enter Remark', 'value' => set_value('description')]); ?>
