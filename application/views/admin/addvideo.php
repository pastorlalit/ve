                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                    ...
                                    switch ($resultMsg) {
                                        case "success":
                                            echo '<div class="alert alert-success square " data-close="true">
                                                               <p>Video Created Successfully! <i class="fa fa-thumbs-o-up ico-block"></i></p>
                                                              </div>';
                                            break;
                                        case "error":
                                ...
                                echo form_open('Videos/InsertVideo', $attributes);
                                ?>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(['class' => 'form-control', 'name' => 'url', 'id' => 'url', 'type' => 'text', 'placeholder' => 'Enter Url link', 'value' => set_value('url')]); ?>
                                    </div>
